...
<body class="dark:bg-black dark:text-white antialiased">
    <main class="animate-fade-right p-4 sm:p-8 md:p-12 lg:p-16 xl:p-20">
        <h1 class=" m-6 title text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl"> Hello, World</h1>
        <p class="mt-4  text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
            ...
            <a class="underline decoration-purple-500 hover:bg-purple-500 transition ease-in-out duration-300" href="/portfolio">portfolio</a>
            and
            <a class="underline decoration-purple-500 hover:bg-purple-500 transition ease-in-out duration-300" href="/blog">blog</a>.
            I am a full stack developer, with experience in Django, Wordpress, and Sveltekit. I am familiar with TailwindCSS and Bootstrap as well.
        </p>

        <p class="sticky bottom-0">Made with ❤️ by Jadon Gearhart - 2023</p>
    </main>
